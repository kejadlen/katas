...
fn test_verse_8() {
  assert_eq!(beer::verse(8),
             "8 bottles of beer on the wall, 8 bottles of beer.\nTake one \
              down and pass it around, 7 bottles of beer on the wall.\n");
}
...
fn test_song_8_6() {
  assert_eq!(beer::sing(8, 6),
             "8 bottles of beer on the wall, 8 bottles of beer.\nTake one \
              down and pass it around, 7 bottles of beer on the wall.\n\n7 \
              bottles of beer on the wall, 7 bottles of beer.\nTake one down \
              and pass it around, 6 bottles of beer on the wall.\n\n6 \
              bottles of beer on the wall, 6 bottles of beer.\nTake one down \
              and pass it around, 5 bottles of beer on the wall.\n");
}
